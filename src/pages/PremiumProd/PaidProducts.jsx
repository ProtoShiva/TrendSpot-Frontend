      ...
      <section className="pt-10 pb-10 lg:pb-20 bg-gray-100/80  font-poppins">
        <div className="container mx-auto ">
          ...
          <div className="flex sm:ml-32 ml-6">
            <div className="py-8 text-center mr-6">
              <div className="relative mb-8 inline-block sm:-ml-[75%] text-left w-[10rem]">
                <p className="ml-2 text-sm mb-2">Select a Platform:</p>
                <button
                  onClick={() => setDropdownOpen(!dropdownOpen)}
                  className="bg-white flex items-center justify-between rounded py-3 w-[10rem] px-5 text-base font-semibold text-black"
                >
                ...
                >
                  <Link
                    ...
                    to={"/premiumProducts"}
                    className="text-body-color hover:bg-primary hover:text-primary block py-2 px-5 text-base font-semibold hover:bg-opacity-5"
                  >
                    All Products
                  </Link>
                  <Link
            ...
            <div className="py-8 text-center ">
              <div className="relative mb-8 inline-block sm:-ml-[25%] text-left w-[35rem]">
                ...
                >
                  <div className="sm:grid sm:grid-cols-3 ">
                    <button
                      ...
                      className="text-body-color hover:bg-primary hover:text-primary block py-[18px] px-[18px] text-base font-semibold hover:bg-opacity-5"
                    >
                      All Categories
                    </button>
                    <button
          ...
          <div className="-mx-4 flex flex-wrap">
            {records?.map((singleProd) => {
              return (
                <>
                  {category === "All" ? (
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3 flex justify-between ">
