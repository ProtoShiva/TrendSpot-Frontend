  ...
  return (
    <div className="max-w-screen overflow-hidden font-poppins ">
      ...
      <div className="flex w-full justify-between items-center bg-gray-800 h-14">
        ...
        <Link
          to={"/"}
          className="text-2xl text-white flex justify-between cursor-pointer "
        >
          <h1 className="ml-8">TrendSpot</h1>
        </Link>
        {/* menu items */}
        <div className="flex justify-center">
          {" "}
          <ul className="justify-center hidden md:flex text-white">
            <li className="flex px-2  hover:text-emerald-500 transition ease-in-out delay-150 duration-300 ">
            ...
            {isAdmin ? (
              <li className="flex px-2 text-emerald-400 ">
        ...
        <div className="">
          <div
            className={`w-[35%] h-[18rem] bg-gray-800 absolute right-8 top-16 rounded-lg z-10 ${
              Open ? null : "hidden"
            }`}
          >
            <div className="flex justify-between">
              ...
              <p className="text-[1rem] text-white bg-emerald-500 w-[40%] h-8 mt-[20px] flex justify-center items-center rounded-lg mr-4">
