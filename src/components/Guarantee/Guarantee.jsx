...
const Guarantee = ({ User }) => {
  return (
    <div>
      <section className="bg-gradient-to-r -mt-20 sm:-mt-0 from-sky-950 to-blue-700 bg-gray-700 text-gray-100">
        <div className="container flex flex-col mx-auto lg:flex-row">
          <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12">
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              className="w-10 h-10 mb-6 text-sky-400"
            >
              <path
                fillRule="evenodd"
            ...
            <Link
              ...
              className="self-start px-10 py-3 text-lg font-medium rounded-3xl bg-sky-400 text-gray-900"
            >
