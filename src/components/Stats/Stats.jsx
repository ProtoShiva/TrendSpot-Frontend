...
const Stats = () => {
  return (
    <div>
      <section className="p-4 my-6 md:p-8 bg-gray-100 sm:-mb-2 text-gray-100">
        <div className="container mx-auto grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3 justify-center">
          <div className="flex overflow-hidden rounded-lg bg-gray-700 text-gray-100">
            <div className="flex items-center justify-center px-4 bg-sky-400 text-gray-800">
              <svg
