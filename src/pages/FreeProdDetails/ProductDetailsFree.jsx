    ...
    <div className="overflow-hidden font-poppins px-4 bg-gray-50">
      <div className=" w-full sm:flex">
        <div className="sm:w-[57%] mt-20 h-[55rem]">
          <img
            className={`sm:h-[30rem] rounded-2xl items-center mx-auto border-2 border-gray-100 object-cover`}
            src={
              image === "1"
          ...
          <div className="grid cursor-pointer place-items-center sm:grid-cols-4 grid-cols-2 mt-4 ">
            ...
            !singleProdGotFree?.image1.endsWith("mp4") ? (
              <img
                onClick={() => setImage("1")}
                className="h-[10rem] rounded-lg p-[3px] object-cover"
            ...
            !singleProdGotFree?.image2.endsWith("mp4") ? (
              <img
                onClick={() => setImage("2")}
                className="h-[10rem] cursor-pointer rounded-lg p-[3px] object-cover"
        ...
        <div className="sm:w-[43%] sm:mt-20 mt-8 h-[55rem]">
          <h1 className="text-4xl">{singleProdGotFree?.title}</h1>
          <div className="mt-10 text-sm ml-8">
