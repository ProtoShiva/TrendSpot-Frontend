          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Instant Full Access</h2>

                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                  After your purchase, you will have access to hundreds of
                  winning products to choose from and all features of TrendSpot!
                </p>
              </a>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Download Instantly</h2>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Save Products</h2>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Platform Search</h2>
              ...
              >
                ...
                <h2 className="mt-2 font-bold">Competitor Research</h2>
