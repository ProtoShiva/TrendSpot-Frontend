...
// import DateFormater from "../../utils/dateFormate.jsx"
...
const ProdDetails = () => {
  ...
  return (
    <div className="overflow-hidden font-poppins px-4 bg-gray-50">
      <div className=" w-full sm:flex mb-4 lg:bg-green-600 h-[70rem] md:bg-orange-600">
      ...
      {/* product Video */}
      <h1 className="text-center text-5xl">Product Creatives</h1>
