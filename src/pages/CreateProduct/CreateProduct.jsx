      ...
      <form className="" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex justify-center pb-8">
          <input
            ...
            className="bordder-[#E9EDF4] m-2 w-[80%] rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none"
          />
        </div>
        <p className="flex justify-start ml-[10%]  text-gray-600">
        ...
        <div className="flex justify-center pb-8">
          <textarea
            ...
            rows="5"
            className="border-form-stroke m-2 w-[80%] placeholder-gray-300 focus:border-blue-400 rounded-lg border-[1.5px] py-3 px-5 outline-none transition disabled:cursor-default disabled:bg-[#F5F7FD]"
          ></textarea>
        </div>
        <p className="flex justify-start ml-[10%]  text-gray-600">
        ...
        <div className="flex justify-start ml-[10%] pb-8">
          <input
            ...
            className="bordder-[#E9EDF4] mt-2 w-[20%] rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none"
          />
        </div>
        <p className="flex justify-start ml-[10%]  text-gray-600">
          Cost of Product
        ...
        <div className="mb-10 flex justify-center pb-20">
          {productLoading ? (
            <button
              disabled
              className="w-[20%] m-2 cursor-pointer rounded-md border bg-slate-600 py-3 px-5 text-base font-semibold text-white transition"
            >
            ...
            <button
              type="submit"
              className="w-[20%] m-2 cursor-pointer rounded-md border bg-blue-600 py-3 px-5 text-base font-semibold text-white transition hover:bg-blue-700"
            >
              Create Product
            </button>
          )}
